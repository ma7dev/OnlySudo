...
def synthesize(model, step, configs, vocoder, batchs, control_values,output_path=None):
...
def infer_tts(text, model, vocoder, configs, bw = True, apply_tshkeel = False, 
             pitch_control = 1.0, energy_control = 1.0, duration_control = 1.0,output_path=None):
    ...
    synthesize(model, '', configs, vocoder, batchs, control_values,output_path=output_path)
